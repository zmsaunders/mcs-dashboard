<div class="sm:flex mt-4">
            <div class="w-full sm:w-1/2 flex-auto sm:pr-2">
                <label class="mr-4 font-bold block mb-2 text-white dark:text-gray-100">Show School</label>
            ...
            <div class="w-full sm:w-1/2 flex-auto sm:pl-2">
                <label class="mr-4 font-bold block mb-2 text-white dark:text-gray-100">Show Week</label>
