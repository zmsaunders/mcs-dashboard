<div>
    ...
    <table class="w-full bg-gray-100">
        <thead class="text-left">
            <tr>
                ...
                <th class="bg-gray-800 text-gray-100 p-2">Students Positive</th>
                <th class="bg-gray-800 text-gray-100 p-2">Students Quarantined</th>
                <th class="bg-gray-800 text-gray-100 p-2">Staff Positive</th>
                <th class="bg-gray-800 text-gray-100 rounded-tr p-2">Staff Quarantined</th>
            </tr>
            <tbody>
    ...
    <div class="flex justify-around">
        <button class="rounded bg-indigo-700 hover:bg-indigo-900 text-indigo-100 font-bold px-6 py-2 flex-1 m-6" wire:click="prevWeek">Previous</button>
        <button class="rounded bg-indigo-700 hover:bg-indigo-900 text-indigo-100 font-bold px-6 py-2 flex-1 m-6" wire:click="nextWeek">Next</button>
    </div>
</div>
