...
class StudentChart extends BaseChart
{
    ...
    public function handler(Request $request): Chartisan
    {
        ...
        return Chartisan::build()
            ...
            ->dataset('Student Positive', array_reverse($this->positive))
            ->dataset('Student Quarantine', array_reverse($this->quarantine));
    }
    ...
    public function gatherData()
    {
        ...
        foreach($weeks as $k => $week) {
            ...
            foreach($week as $case) {
                $this->positive[$k] += $case->student_positive;
                $this->quarantine[$k] += $case->student_quarantine;
            }
        }
    }
}
